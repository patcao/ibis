...
def _get_post_process_function(frame: ops.Window) -> Callable:
...
def get_aggcontext_window(
    ...
    **kwargs,
    ...
    elif window.preceding is not None:
...
def execute_window_op(
    ...
    **kwargs,
    ...
    if (
        not isinstance(op.expr._arg, ops.AnalyticVectorizedUDF)
